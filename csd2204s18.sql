...
--
-- Host: 127.0.0.1
-- Generation Time: May 17, 2018 at 05:35 PM
...
INSERT INTO `c1` (`name`, `nickname`, `city`, `postalcode`, `age`, `custID`) VALUES
...
INSERT INTO `c3` (`customerID`, `name`, `city`, `postalcode`, `age`, `Country`) VALUES
...
INSERT INTO `cust_mast` (`cust_no`, `name`, `add1`, `add2`, `add3`, `city`, `state`) VALUES
...
(45717, 'PAØl', '08', 'Clemons', 'Drive', 'Tacoma', 'Washington'),
...
CREATE TABLE `movies` (
  ...
  `Length_Minutes` int(5) DEFAULT NULL,
  `BOCollection` float(5,2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `movies` (`ID`, `Title`, `Director`, `Year`, `Length_Minutes`, `BOCollection`) VALUES
...
(6, 'Paris Is Burning', 'Carri Garrals', 1995, 50, 26.55),
...
--
-- Table structure for table `moviesnew`
--
...
--
-- Indexes for table `moviesnew`
--
ALTER TABLE `moviesnew`
  ADD PRIMARY KEY (`ID`);
